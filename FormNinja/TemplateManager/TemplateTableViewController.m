...
- (void)viewDidLoad
{
	...
	[self setTemplateNameList:[[NSMutableArray alloc] initWithCapacity:1]];
	[templateNameList addObject:@"test1"];
	[templateNameList addObject:@"test2"];
	[templateNameList addObject:@"test3"];
}
